...
public class MediaRecordNewActivity extends Activity
//        implements MediaRecorderBase.OnErrorListener, View.OnClickListener, MediaRecorderBase.OnPreparedListener,
...
//        mMediaRecorder = new MediaRecorderNewNative();
//
...
//            intent.putExtra(MediaRecordNewActivity.OUTPUT_DIRECTORY, mMediaObject.getOutputDirectory());
//            intent.putExtra(MediaRecordNewActivity.VIDEO_URI, mMediaObject.getOutputTempTranscodingVideoPath());
//            intent.putExtra(MediaRecordNewActivity.VIDEO_SCREENSHOT, mMediaObject.getOutputVideoThumbPath());
...
//        super.onStop();
//        if (mMediaRecorder instanceof MediaRecorderNewNative) {
//            ((MediaRecorderNewNative) mMediaRecorder).activityStop();
//        }
//        hideProgress();
