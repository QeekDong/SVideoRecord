...
public abstract class MediaRecorderBaseNew implements SurfaceHolder.Callback, Camera.PreviewCallback, IMediaRecorder {
     ...
     * 转码监听器
     */
    protected MediaRecorderBaseNew.OnEncodeListener mOnEncodeListener;
    /**
     * 录制错误监听
     */
    protected MediaRecorderBaseNew.OnErrorListener mOnErrorListener;
    /**
     * 录制已经准备就绪的监听
     */
    protected MediaRecorderBaseNew.OnPreparedListener mOnPreparedListener;
     ...
     * 设置转码监听
     */
    public void setOnEncodeListener(MediaRecorderBaseNew.OnEncodeListener l) {
     ...
     * 设置预处理监听
     */
    public void setOnPreparedListener(MediaRecorderBaseNew.OnPreparedListener l) {
     ...
     * 设置错误监听
     */
    public void setOnErrorListener(MediaRecorderBaseNew.OnErrorListener l) {
        mOnErrorListener = l;
    }
