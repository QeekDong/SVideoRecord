...
public class MediaRecorderNativeNew extends MediaRecorderBaseNew implements MediaRecorder.OnErrorListener, FFmpegBridge.FFmpegStateListener {

    public MediaRecorderNativeNew() {
